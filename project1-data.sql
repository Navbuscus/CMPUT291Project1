...
VALUES ('123456789','ser1234567890','y');

INSERT INTO owner (OWNER_ID , VEHICLE_ID , IS_PRIMARY_OWNER)
VALUES ('223456789','ser2234567890','y');

INSERT INTO owner (OWNER_ID , VEHICLE_ID , IS_PRIMARY_OWNER)
VALUES ('323456789','ser3234567890','n');

INSERT INTO owner (OWNER_ID , VEHICLE_ID , IS_PRIMARY_OWNER)
VALUES ('423456789','ser4234567890','y');

INSERT INTO owner (OWNER_ID , VEHICLE_ID , IS_PRIMARY_OWNER)
VALUES ('423456789','ser5234567890','y');

INSERT INTO owner (OWNER_ID , VEHICLE_ID , IS_PRIMARY_OWNER)
VALUES ('423456789','ser6234567890','y');

/*AUTO_SALE*/
INSERT INTO auto_sale (TRANSACTION_ID , SELLER_ID , BUYER_ID , VEHICLE_ID , S_DATE , PRICE )
VALUES (100,'123456789','223456789','ser2234567890',TO_DATE('20000101', 'YYYYMMDD'),20000.00);

INSERT INTO auto_sale (TRANSACTION_ID , SELLER_ID , BUYER_ID , VEHICLE_ID , S_DATE , PRICE )
VALUES (101,'123456789','323456789','ser3234567890',TO_DATE('20000101', 'YYYYMMDD'),40000.00);

INSERT INTO auto_sale (TRANSACTION_ID , SELLER_ID , BUYER_ID , VEHICLE_ID , S_DATE , PRICE )
VALUES (102,'323456789','123456789','ser1234567890',TO_DATE('20000101', 'YYYYMMDD'),20000.00);
...
VALUES (1000, '123456789', 'ser1234567890','123456789','parking',TO_DATE('20141201', 'YYYYMMDD'),'traffic','schoolzone');

INSERT INTO ticket (TICKET_NO , VIOLATOR_NO , VEHICLE_ID , OFFICE_NO , VTYPE , VDATE , PLACE , DESCRIPTIONS) 
VALUES (2000, '123456789', 'ser1234567890','123456789','parking',TO_DATE('20141201', 'YYYYMMDD'),'traffic','schoolzone');

INSERT INTO ticket (TICKET_NO , VIOLATOR_NO , VEHICLE_ID , OFFICE_NO , VTYPE , VDATE , PLACE , DESCRIPTIONS) 
VALUES (4000, '123456789', 'ser1234567890','123456789','parking',TO_DATE('20141201', 'YYYYMMDD'),'traffic','schoolzone');

INSERT INTO ticket (TICKET_NO , VIOLATOR_NO , VEHICLE_ID , OFFICE_NO , VTYPE , VDATE , PLACE , DESCRIPTIONS) 
VALUES (3000, '123456789', 'ser1234567890','123456789','hitandrun',TO_DATE('20000101', 'YYYYMMDD'),'traffic light','schoolzone');
